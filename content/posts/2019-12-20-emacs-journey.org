...
* What Has Not Changed
  :PROPERTIES:
  :CUSTOM_ID: what-has-not-changed-311
  :END:
...
* Terrific Task Management
  :PROPERTIES:
  :CUSTOM_ID: terrific-task-management-719
  :END:
...
* Underwhelming Windows Performance
  :PROPERTIES:
  :CUSTOM_ID: underwhelming-windows-performance-665
  :END:
...
* Literate Dotfiles
  :PROPERTIES:
  :CUSTOM_ID: literate-dotfiles-715
  :END:
...
this org file. I have mentioned this process in a [[file:2019-08-10-literate-dotfiles.org][previous post]].

* Keybindings
  :PROPERTIES:
  :CUSTOM_ID: keybindings-791
  :END:
...
* The Journey Continues
  :PROPERTIES:
  :CUSTOM_ID: the-journey-continues-449
  :END:
