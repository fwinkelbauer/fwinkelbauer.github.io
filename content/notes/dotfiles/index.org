...
chunkyard store --repository ~/.chunkyard --directory ~/Documents "$@"
...
chunkyard restore --repository ~/.chunkyard --directory ~/Documents "$@"
#+end_src
...
for remote in "${remotes[@]}"; do
    if [ -d "$remote" ]; then
        ...
        chunkyard sync --first "$local" --second "$remote"
    fi
done
#+end_src
