...
sudo apt update
sudo apt install emacs git homebank keepassxc librewolf
...
(setq package-selected-packages '(embark-consult embark consult vertico orderless corfu cape magit color-theme-sanityinc-tomorrow)
